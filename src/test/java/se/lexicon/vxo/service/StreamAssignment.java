...
import se.lexicon.vxo.model.util;
...
public class StreamAssignment {
    ...
    private util.UsefulMethods usefulMethods = new util.UsefulMethods();
    ...
    public void task12(){
      ...
      result = people.stream()
              ...
              .sorted()
              .toArray(String[]::new);
             //  .filter(person -> person.getFirstName().equals())
    ...
    public void task14(){
        ...
        _2020_dates = usefulMethods.generateYearOf(year);
